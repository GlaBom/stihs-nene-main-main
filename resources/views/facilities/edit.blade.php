                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-0 position-relative">
                                ...
                                <div class="col-sm-12">
                                    <input name='facilities_name' class="form-control" type="text"
                                        value="{{ $facility->facilities_name }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-0 position-relative">
                                ...
                                <div class="col-sm-12">
                                    <input name='facilities_room' class="form-control" type="text"
                                        value="{{ $facility->facilities_room }}" required>
                                </div>
                            </div>
                        </div>
