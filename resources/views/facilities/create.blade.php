                ...
                <form action="{{ route('facilities.store') }}" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="mb-0 position-relative"><br>
                            ...
                            <div class="col-sm-12">
                                <input name='facilities_name' class="form-control" type="text" value="{{ old('facilities_name') }}">
                            </div>
                        </div>
                    </div><br>
                    ...
                    <div class="col-md-12">
                        <div class="mb-0 position-relative"><br>
                            ...
                            <div class="col-sm-12">
                                <input name='facilities_room' class="form-control" type="text" value="{{ old('facilities_room') }}">
                            </div>
                        </div>
