                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{ asset('logo\stihslogo.png') }}" height="70" class="logo-dark mx-auto" alt="">
                                    <img src="{{ asset('logo\stihslogo.png') }}" height="70" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>
...
@csrf
    ...
    <div class="form-group mb-3 row">
        <div class="col-12">
            <input class="form-control" id="paaword" type="password" name="password" required="" placeholder="Password">
        </div>
    </div>
