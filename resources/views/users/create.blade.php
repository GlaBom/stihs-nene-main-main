                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-0 position-relative"><br>
                                ...
                                <select name="user_type" class="form-control" required>
                                    ...
                                    <option value="User">Property Custodian</option>
                        ...
                        {{-- <div class="col-md-4">
                            <div class="mb-0 position-relative"><br>
                                ...
                                <input name='user_profile_photo_path' class="form-control" type="number" value="{{ old('user_profile_photo_path') }}">
                                @error('user_profile_photo_path')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                @enderror
